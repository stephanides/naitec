...
export const GiveawayContactForm = ({ country }: { country: string }) => {
  ...
  return (
    <Element name="giveaway-form" id="giveaway-form">
      <Box
        mt={rem(96)}
      ...
      >
        ...
        >
          ...
          >
            <span
              dangerouslySetInnerHTML={{ __html: t('form_description_1') }}
            />
            <a href="/">
              <Text
                fontWeight="bold"
            ...
            <span
              dangerouslySetInnerHTML={{ __html: t('form_description_3') }}
            />
            <a href="/">
              <Text
                fontWeight="bold"
            ...
            <span
              dangerouslySetInnerHTML={{ __html: t('form_description_5') }}
            />
          </NeueHaasGroteskText>
        </Flex>
